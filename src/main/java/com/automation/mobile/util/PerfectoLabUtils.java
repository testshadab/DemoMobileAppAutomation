...
public class PerfectoLabUtils {
    ...
    private static final Logger logger = LogManager.getLogger(PerfectoLabUtils.class);
    ...
    private static final String HOST = "safeway.perfectomobile.com";
...
//			String encodedPassword = URLEncoder.encode(password, "UTF-8");
    ...
    public static String getRepositoryList(String repositoryKey, String cloud_uname, String cloud_pwd) throws IOException {
        //replace spaces with url encoded value
//        String encodedSecurityToken = URLEncoder.encode(securityToken, "UTF-8");

        String urlStr = HTTPS + HOST + MEDIA_REPOSITORY + repositoryKey
                + "?operation=list&user=" + cloud_uname + "&password=" + cloud_pwd + "";
        URL url = new URL(urlStr);
