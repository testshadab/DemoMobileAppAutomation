...
public class DeviceHelper {
  ...
  public static By airplaneBtnIOS =
      MobileBy.xpath("//XCUIElementTypeSwitch[@name='Airplane Mode']");
  public static By wifiStatusIOS = MobileBy.xpath("//XCUIElementTypeCell[@name='Wi-Fi']");
  public static By wifiSwitchIOS = MobileBy.xpath("//XCUIElementTypeSwitch[@label='Wi-Fi']");
  public static By networkAndInternetSettingAndroid =
      MobileBy.AndroidUIAutomator("new UiSelector().text(\"Network & internet\")");
  public static By wifiStatusAndroid = MobileBy.xpath("//*[@text='Wi‑Fi']//following-sibling::*");
  public static By wifiToggleAndroid =
      MobileBy.xpath("//android.widget.Switch[@content-desc='Wi‑Fi']");
  ...
  public boolean turnOnOffAirplaneModeIOS(String desiredStatus) {
    ...
    int expectedAirplaneModeStatus =
        Integer.parseInt(driver.findElement(airplaneBtnIOS).getAttribute("value"));
    ...
    switch (desiredStatus.toUpperCase()) {
      case "ON":
        if (currentWifiStatus.contains("Off")) {
          ...
          basePage.waitForElement(wifiSwitchIOS, 5);
          try {
            for (int i = 0; i < 3; i++) {
              if (driver.findElement(wifiSwitchIOS).getAttribute("value").equalsIgnoreCase("0")) {
                basePage.clickElement(driver.findElement(wifiSwitchIOS));
                try {
                  Thread.sleep(3000);
