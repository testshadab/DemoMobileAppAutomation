...
public class PageActions extends BasePage {
    ...
    /**
     * This will scroll across the whole card/ element given
     *
     * @param ele
     */
    public void slideAcrossTheCardFromRightToLeft(MobileElement ele) {
        Point pt = ele.getLocation();
        scroll((int) (ele.getSize().getWidth() * 0.98), pt.getY(), (int) (ele.getSize().getWidth() * 0.02), pt.getY());
    }

    /**
     * This will scroll partially across the card/ element given
     *
     * @param ele
     */
    public void slidePartiallyAcrossTheCardFromRightToLeft(MobileElement ele) {
        Point pt = ele.getLocation();
        scroll((int) (ele.getSize().getWidth() * 0.98), pt.getY(), (int) (ele.getSize().getWidth() * 0.50), pt.getY());
    }
}
